        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-12">
                    ...
                    <ul>
                        ...
                        <li>
                            ProcessWire Content Management System: aka wordpress
                            for developpers
                        </li>
                        <li>
                            Hosting tips for websites and teams, deployment on
                            herokuapp.com
                        </li>
                    </ul>
                </div>
            ...
            <div className="row">
                ...
                <div className="col-lg-12">
                    ...
                    <ul>
                        <li>
                            Layouts for Flyers, Posters, Brochures, Fanzines and
                            Web
                        </li>
                        <li>Designs for social media communication</li>
                        <li>Whatsapp, Instagram Stickers</li>
                        <li>Layouts in Arabic & Persian alphabets possible</li>
                    </ul>
                </div>
                ...
                <div className="col-lg-12">
                    ...
                    <ul>
                        ...
                        <li>
                            Vector images in Arabic & Persian alphabets possible
                        </li>
                    </ul>
                </div>
            </div>
